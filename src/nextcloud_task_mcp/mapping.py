...
class TaskFields:
    ...
    `status` defaults to "open" when left unset (no STATUS property is
    ...
    complete. `"completed"` mirrors `complete_task`
    (STATUS/PERCENT-COMPLETE/COMPLETED), `"open"` is the reopen path
...
def parse_vtodo(component) -> dict[str, Any]:
    ...
    return {
        ...
        "parent_uid": extract_parent_uid(component),
